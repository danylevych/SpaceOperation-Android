...
public class Bullet : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        startShpereSize = gameObject.GetComponent<SphereCollider>().radius;
    ...
    private void Update()
    {
        ...
        if (transform.localScale.x >= 0f && transform.localScale.y >= 0f && transform.localScale.z >= 0f)
        {
            ...
            gameObject.GetComponent<SphereCollider>().radius = startShpereSize;
        }
    }
